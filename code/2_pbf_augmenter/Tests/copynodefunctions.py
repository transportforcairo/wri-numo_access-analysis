...
###################### 
road_path = '/home/hussein-mahfouz/sf_out.osm'
newwayID_seed = 1000 
output_file_name = 'SF_real2.osm'
...
### San Francisco
avgspeed = '/home/hussein-mahfouz/32_wri_numo/4_Tool_Development/2_transform/avg_speeds/sf_output.csv'
...
def CheckNodesForSpeeds (wayID, originalway, units,speedsDFpeak, verbose = 'no'):
    """
