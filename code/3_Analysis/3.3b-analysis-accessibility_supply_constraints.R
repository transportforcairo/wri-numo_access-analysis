...
#                      verbose = TRUE,
#                      use_elevation = FALSE,   # we need to download a tiff file and then turn this to TRUE
#                      overwrite = TRUE)

# code to calculate detailed itineraries for each OD pair using each different mode combination (slow)
